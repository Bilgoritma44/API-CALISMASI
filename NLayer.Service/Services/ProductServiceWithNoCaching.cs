...
namespace NLayer.Service.Services
{
    public class ProductServiceWithNoCaching : Service<Product>, IProductService
    {
        ...
        public ProductServiceWithNoCaching(IGenericRepository<Product> repository, IUnityOfWork unityOfWork,IMapper mapper,IProductRepository productRepository) : base(repository, unityOfWork)
        {
            _mapper= mapper;
